<?php
	/**
	 * Elgg groupextended plugin edit action.
     * Replace edit action from groups plugin
	 * 
	 * @package ElggGroups
	...
	if ((isset($_FILES['icon'])) && (substr_count($_FILES['icon']['type'],'image/')))
	{
        ...
        // Change Call of get_resized_image_from_existing_file() for managment
        // $square parameter from Groupextended plugin settings
